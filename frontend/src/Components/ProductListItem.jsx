             ...
             <div>
                <h3 className="text-lg font-medium text-gray-800 mb-2">{product.title}</h3>
                 <div className="flex items-center gap-2 mb-2">
                    ...
                    <span className="text-gray-400 line-through text-sm">$1128.00</span>
                 </div>
                 <div className="flex items-center gap-4 text-sm text-gray-500 mb-2">
                    <div className="flex text-amber-500">
                        {[...Array(5)].map((_, i) => (
                        <Star key={i} size={14} fill={i < 4 ? "currentColor" : "none"} className={i < 4 ? "text-amber-500" : "text-gray-300"} />
                        ))}
                    </div>
                    <span>7.5</span>
